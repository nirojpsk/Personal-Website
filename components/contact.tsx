      ...
      <div className="max-w-5xl mx-auto px-6 space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-3">
              {socialLinks.map((link, i) => (
                <a
                  ...
                  className="spotlight-container card-pop group flex items-center gap-4 p-4 bg-card/60 border border-border rounded-xl hover:border-accent/30 transition-all duration-300 hover:shadow-[0_5px_20px_oklch(0_0_0_/_0.1)] relative overflow-hidden"
                >
                  {/* Accent bar */}
                  <div
          ...
          <div className="reveal">
            <div className="spotlight-container card-pop bg-card/60 border border-border rounded-2xl p-8 space-y-8 relative overflow-hidden hover:border-accent/30 transition-all duration-300">
              {/* Corner decoration */}
              ...
              <a
                href="mailto:karkibri2073@gmail.com"
                className="magnetic-btn group flex items-center justify-center gap-3 w-full px-8 py-4 bg-accent text-accent-foreground rounded-xl font-semibold text-base transition-all duration-300 hover:shadow-[0_0_30px_oklch(0.75_0.22_150_/_0.3)]"
              >
